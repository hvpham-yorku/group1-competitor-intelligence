...
import type { ProductDetail, ProductHistoryPoint } from "@/services/products/utils";
...
function PriceHistoryChart({ points }: { points: ProductHistoryPoint[] }) {
    ...
    <div className="rounded-xl border border-white/10 bg-black/20 p-4">
      <div className="mb-3">
        ...
        <p className="text-sm text-muted-foreground">
          Snapshot series reconstructed from collected scrape observations.
        </p>
      </div>
      {chartData.length === 0 ? (
  ...
  if (!detail) {
    return (
      <div className="flex min-h-[60vh] flex-col items-center justify-center gap-4">
        ...
        <Link className="text-sm text-muted-foreground underline" href="/products">
          Back to products
        </Link>
      </div>
    );
    ...
    <div className="flex flex-col gap-6 p-4">
      <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
        <div className="space-y-3">
          <Link className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground" href="/products">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card className="border-white/10 bg-white/[0.02]">
          <CardHeader>
            ...
            <CardTitle>{summary.latest_seen_at ? formatDate(summary.latest_seen_at) : "N/A"}</CardTitle>
          </CardHeader>
        </Card>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-[minmax(0,4fr)_minmax(280px,1fr)]">
        ...
        <Card className="border-white/10 bg-white/[0.02]">
          <CardHeader>
            ...
            <CardDescription>
              Latest snapshots collected for this product.
            </CardDescription>
          </CardHeader>
